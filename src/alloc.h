...
DEFINE_CLEANUP_FUNCTION_NULL(GMainLoop*, g_main_loop_unref)
#define gc_main_loop_unref CLEANUP(g_main_loop_unref)

DEFINE_CLEANUP_FUNCTION_NULL(GOptionContext*, g_option_context_free)
#define gc_option_context_free CLEANUP(g_option_context_free)
